...
<template>
  <div class="container">
    <header>
      ...
      <h1 class="title">Formulario SAMS — 3</h1>
          ...
          >
            ...
            <div class="form-field">
              <label for="pseudoICTerm"
                >¿Cuál es el triaje que un SAMS debe seguir a la hora de atender pacientes?</label
              >
              <textarea
                id="pseudoICTerm"
...
<style scoped>
/* --- Copiado y adaptado del estilo que enviaste, mantiene toda la estética --- */
:root {
  --dark-bg: #0d1117;
  --dark-card: #161b22;
