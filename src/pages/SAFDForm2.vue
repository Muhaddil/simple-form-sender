...
async function sendToDiscord(sections: string[]) {
  ...
  let messageBuffer = '# Nueva Respuesta Formulario SAFD 2:\n';
  ...
  <div class="form-container">
    ...
    >
      ...
      <FormTextarea
        ...
        label="¿Como actuarias en un incendio?"
        placeholder="Describe como actuarias en un incendio de manera detallada"
